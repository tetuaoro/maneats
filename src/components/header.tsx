...
// import { generateArray } from "@libs/functions"
import { email, fbId, sitename, telephone } from "@libs/siteinfos"
...
const Header = () => {
  ...
  return (
    <header className={styles.displayUnset}>
      <Navbar
        // ref={navbarRef}
        className={`border-top border-5 border-primary ${styles.transition03}`}
      ...
      {pathname == "/" && (
        <section /* ref={coverPictureRef} */ className={`d-flex justify-content-center bg-black ${styles.transition0}`}>
